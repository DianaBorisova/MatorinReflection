...
public class BeanUtils {
    ...
    public static void assign(Object to, Object from) {
        Method[] getMethods = from.getClass().getMethods(); //getClass() return Class<TestClass> getMethod() return methotds
        ...
        for (Method getMethod: getters) {
            ...
            for (Method setMethod: setters) {
                ...
                if ((name1.equals(name2)) &&
                    ...
                    try {
                        setMethod.invoke(to, getMethod.invoke(from)); //вызываем метод с помощью invoke и записываем значения из а в b
                    } catch (Exception e) {
                    }
                }
            }
